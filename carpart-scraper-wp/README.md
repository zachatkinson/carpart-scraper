...
| Part Page | Distributor URL, Technical service URL, Note, Fitment layout, Related parts | Buttons under the part title (`{sku}` placeholder), the small print beneath them, fitment as a table or expandable cards, and how many "Other parts for this vehicle" cards to show. |
